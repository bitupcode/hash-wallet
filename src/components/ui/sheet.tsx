  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed inset-y-0 right-0 z-[51] w-[min(100vw,32rem)] bg-white p-6 shadow-xl outline-none overflow-y-auto rounded-l-2xl",
          className
        )}
        style={{ height: "100dvh" }}
        {...props}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-3 sm:flex-row sm:justify-start",
        className
      )}
      {...props}
    />
